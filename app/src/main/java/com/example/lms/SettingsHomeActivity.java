...
public class SettingsHomeActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.settigns_home);
        initEvents();
        db = new DatabaseHandler(this);
    }

    public void initEvents() {
        findViewById(R.id.btn_sth_import).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(SettingsHomeActivity.this, SettingsImportActivity.class);
                startActivity(i);
            }
        });
        findViewById(R.id.btn_sth_export).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        findViewById(R.id.btn_sth_back).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SettingsHomeActivity.this, ManagerHomeActivity.class));
            }
        });
    }
    ...
    public class TableExportHelper extends AsyncTask<String, Void, Boolean> {
        private final ProgressDialog dialog = new ProgressDialog(SettingsHomeActivity.this);
            ...
            try {
                ...
                if(ordersList !=null) {
                    for (Order order : ordersList) {
                        ...
                        ordersText.append("|");
                        ordersText.append( order.getNetVatAmt() );
                        ordersText.append("\r\n");
